...
export class IdeasComponent implements OnInit{
  ...
  selectedContreMaitre :string = 'All';
   ...
   ngOnInit(): void {
    this.states.push('All',IdeaState.CREATED,IdeaState.INPROGRESS,IdeaState.CLOSED);
  ...
  onTableAction(e: TableButtonAction): void {    
    if (e.name === 'details')
    {
      ...
      this.router.navigateByUrl('dashboard/ideas/details/'+e.value.ideeNumber);
    }
  }
  associatedTableAction(e:TableButtonAction):void{
    ...
    {            
      this.dataService.transfertObject(e.value);
      this.router.navigateByUrl('dashboard/ideas/details/'+e.value.ideaId);
    }
  }
  // chefSegmentActions(e : TableButtonAction):void{
  //   if (e.name === 'details')
  //   {
  //     this.router.navigateByUrl('dashboard/ideas/details/'+e.value.ideeNumber);
  //   }
  ...
  // expertActions(e:TableButtonAction):void
  // {
  //   if (e.name === 'details')
  //   {
  //     this.dataService.transfertObject(e.value);
