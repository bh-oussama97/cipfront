...
export class SegmentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dataSource = new MatTableDataSource(this.segmentsData);
  }
  addSegment() {
    this.router.navigateByUrl('dashboard/segments/add');
  }
  ...
  onTableAction(e: TableButtonAction): void {
    if (e.name === 'edit') {
      this.router.navigateByUrl('dashboard/segments/edit/' + e.value['id']);
    }
    if (e.name === 'delete') {
